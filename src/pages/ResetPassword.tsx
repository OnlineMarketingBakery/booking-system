...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSubmitted(true);
      toast({ title: "Check your email", description: "Click the link to confirm your new password. Until you confirm, you cannot sign in." });
    } catch (err: any) {
      ...
      <div className="flex min-h-screen items-center justify-center bg-muted/30 px-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              We’ve sent you an email. Click the link in the email to confirm your new password. Until you confirm, you cannot sign in.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild className="w-full">
